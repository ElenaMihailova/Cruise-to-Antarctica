...
window.onload = function () {
  ...
  ;
  pristine.addValidator(document.querySelector('.js-input--tel'), validatePhone, 'Телефонный номер в формате 89236889975');
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_utils_menu__WEBPACK_IMPORTED_MODULE_2__["menuHeader"])('.header__button', 'header');
  Object(_utils_menu__WEBPACK_IMPORTED_MODULE_2__["closeMenu"])('.header__cover-js', '.header');
  Object(_utils_menu__WEBPACK_IMPORTED_MODULE_2__["closeMenuLink"])('.header');
...
/*!**************************!*\
  !*** ./js/utils/menu.js ***!
  \**************************/
/*! exports provided: menuHeader, closeMenu, closeMenuLink */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "closeMenuLink", function() { return closeMenuLink; });
/* harmony import */ var _scroll_lock__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./scroll-lock */ "./js/utils/scroll-lock.js");

var _scrollLock = new _scroll_lock__WEBPACK_IMPORTED_MODULE_0__["ScrollLock"]();
var closeMenu = function closeMenu(coverElem, menuElem) {
  var menu = document.querySelector(menuElem);
  var cover = document.querySelector(coverElem);
  cover.addEventListener('click', function () {
    menu.classList.remove('header--opened');
    _scrollLock.enableScrolling();
  });
};
var closeMenuLink = function closeMenuLink(menuElem) {
  var links = document.querySelector('.header__navigation').querySelectorAll('.navigation__link');
...
var menuHeader = function menuHeader(buttonElem, menuElem) {
  var button = document.querySelector(buttonElem);
  var menu = document.getElementById(menuElem);
